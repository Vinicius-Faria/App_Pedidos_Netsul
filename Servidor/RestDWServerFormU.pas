...
Uses LCL, LCLIntf, LCLType, Messages, SysUtils, Variants, Classes, Graphics,
  Controls, Forms, Dialogs, uSock, IniFiles, IBConnection, db, uRESTDWBase,
  uRESTDWPoolerDB, uDWResponseTranslator, ServerMethodsUnit1, ComCtrls,
  MaskEdit, StdCtrls, ExtCtrls, Menus, Buttons, DBGrids, IdComponent,
...
procedure TRestDWForm.Button1Click(Sender: TObject);
begin
